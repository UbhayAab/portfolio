...
// prettier-ignore
const glyphs = [
  'क्र', 'त्र', 'ग्र', 'शा', 'भि', 'कु', 'धा', 'टु', 'लि', 'प्र', 'किताब', 'सपना', 'गाना', 'बच्चा', 'मेहनत', 'किताब', 'सपना', 'गाना', 'बच्चा', 'मेहनत', 'अ', 'आ', 'इ', 'ई', 'उ', 'ऊ', 'ऋ', 'ए', 'ऐ', 'ओ', 'औ', 'अं', 'क', 'ख', 'ग', 'घ', 'च', 'छ', 'ज', 'झ', 'ट', 'ठ', 'ड', 'ढ', 'त', 'थ', 'द', 'ध', 'न', 'प', 'फ', 'ब', 'भ', 'म', 'य', 'र', 'ल', 'व', 'श', 'ष', 'स',
];
